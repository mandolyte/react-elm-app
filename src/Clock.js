...
var $author$project$Clock$AdjustTimeZone = function (a) {
	return {$: 'AdjustTimeZone', a: a};
};
var $author$project$Clock$Model = F2(
	function (zone, time) {
...
var $author$project$Clock$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			$author$project$Clock$Model,
			$elm$time$Time$utc,
			$elm$time$Time$millisToPosix(0)),
		A2($elm$core$Task$perform, $author$project$Clock$AdjustTimeZone, $elm$time$Time$here));
};
...
var $author$project$Clock$subscriptions = function (model) {
	return A2($elm$time$Time$every, 1000, $author$project$Clock$Tick);
};
...
var $author$project$Clock$timeToString = function (_int) {
	return A3(
...
var $author$project$Clock$view = function (model) {
	var second = $author$project$Clock$timeToString(
		A2($elm$time$Time$toSecond, model.zone, model.time));
	var minute = $author$project$Clock$timeToString(
		A2($elm$time$Time$toMinute, model.zone, model.time));
	var hour = $author$project$Clock$timeToString(
		A2($elm$time$Time$toHour, model.zone, model.time));
	var _v0 = $elm$time$Time$posixToMillis(model.time);
	if (!_v0) {
		return A2($elm$html$Html$h1, _List_Nil, _List_Nil);
	} else {
		var time = _v0;
		return A2(
			$elm$html$Html$h1,
