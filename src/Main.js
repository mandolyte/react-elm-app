...
var $author$project$Main$timeToString = function (_int) {
	return A3(
...
var $author$project$Main$view = function (model) {
	var second = $author$project$Main$timeToString(
		A2($elm$time$Time$toSecond, model.zone, model.time));
	var minute = $author$project$Main$timeToString(
		A2($elm$time$Time$toMinute, model.zone, model.time));
	var hour = $author$project$Main$timeToString(
